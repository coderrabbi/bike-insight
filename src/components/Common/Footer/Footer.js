...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-red-500">
      <svg
        className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-red-500"
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            <Link
              title="Company"
              className="inline-flex items-center bg-white w-[120px] h-[120px] rounded-full mx-auto"
            >
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  <Link className="transition-colors duration-300 text-gray-200 hover:text-white">
                    Naked Bikes
                  </Link>
                </li>
              </ul>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          <p className="text-sm text-white">
            © Copyright 2022 Golam Rabbi. All rights reserved.
          </p>
